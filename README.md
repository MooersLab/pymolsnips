...
<h2>Gallery</h2>
	...
	<!-- pdb code 5d99, 27-mer RNA hairpin -->
        ...
        <td align="left"><img src="./images/5d99AOD.png" alt="HTML5 Icon" style="width:600px;height:600px;"> </td>
        <td align="left"><h4>ambient occlusion</h4> <p>This variant of ambient occulusion colors the carbon atoms black. This code can be applied to any molecule in a sphere representation.</p> </td>
     </tr>
      <tr>
